...
class ISimulacionRepository(ABC):
    ...
    def guardar_llega_cliente_atiende(self, coleccion_id: int, hora: str, evento: str, rnd_llegada: float, tiempo_hasta_llegada: str,
        ...
        self.guardar_fila(coleccion_id, hora, evento, rnd_llegada, tiempo_hasta_llegada, proxima_llegada, estado_tecnico,
    ...
    def guardar_llega_cliente_no_atiende(self, coleccion_id: int, hora: str, evento: str, rnd_llegada: float, tiempo_hasta_llegada: str,
                                      proxima_llegada: str, estado_tecnico: str,proximo_fin_atencion: str, cola_atencion_cantidad: int,
                                      cola_equipos_cantidad: int, tiempo_atencion_acum, tiempo_reparacion_acum,
                                      clientes_no_atendidos_por_cierre: int, cola_clientes: Any,
                                      cola_equipos: Any) -> None:
    ...
    def guardar_llega_cliente_repara(self, coleccion_id: int, hora: str, evento: str, rnd_llegada: float, tiempo_hasta_llegada: str,
    ...
    def guardar_fin_atencion_hay_clientes(self, coleccion_id: int, hora: str, evento: str, hora_proxima_llegada: str, estado_tecnico: str,
                     ...
                     cola_equipos_cantidad: int, tiempo_atencion_acum, tiempo_reparacion_acum,
                                      clientes_no_atendidos_por_cierre: int, cola_clientes: Any,
                                      cola_equipos: Any) -> None:
        self.guardar_fila(coleccion_id, hora, evento, -1,
    ...
    def guardar_fin_atencion_no_hay_clientes(self, coleccion_id: int, hora: str, evento: str,
    ...
    def guardar_fin_atencion_hay_equipos(self, coleccion_id: int, hora: str, evento: str, hora_proxima_llegada: str, estado_tecnico: str,
    ...
    def guardar_fin_reparacion_no_hay_equipos(self, coleccion_id: int, hora: str, evento: str, hora_proxima_llegada: str, estado_tecnico: str,
                     cola_atencion_cantidad: int, cola_equipos_cantidad: int, tiempo_atencion_acum, tiempo_reparacion_acum,
                     clientes_no_atendidos_por_cierre: int, cola_clientes: Any,
                     cola_equipos: Any) -> None:
    ...
    def guardar_fin_reparacion_hay_equipos(self, coleccion_id: int, hora: str, evento: str,
    ...
    # endregion Métodos específicos para cada tipo de evento (para no repetir argumentos innecesarios)